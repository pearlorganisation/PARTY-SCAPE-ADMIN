...
import {deleteProspectiveCustomer, getAllProspectiveCustomers } from '../actions/prospectiveCustomer';
    ...
    builder
      ...
      .addCase(deleteProspectiveCustomer.rejected, (state, action) => {
        ...
        state.prospectiveCustomerData = state.prospectiveCustomerData.filter(
          (prospectiveCustomer) => prospectiveCustomer._id !== action?.payload?.payload
        );
      });
  },
});
